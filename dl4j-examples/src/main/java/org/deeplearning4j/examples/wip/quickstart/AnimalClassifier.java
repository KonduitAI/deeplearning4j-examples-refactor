...
/**
 * Issue Sumamry: The labels in the test data are incorrect (all the same). So even though net trains properly it gives terrible eval results.
 * Github issue: https://github.com/eclipse/deeplearning4j-examples/issues/967
 *
