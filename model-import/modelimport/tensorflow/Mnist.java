...
public class Mnist {
    ...
    public static INDArray predict(INDArray arr){
        ...
        placeholder.put(sd.inputs().get(0),batchedArr);
        INDArray out = sd.outputSingle(placeholder,"dense_4/Softmax");
    ...
    public static INDArray predict (String filepath) throws IOException{
        ...
        INDArray arr = Nd4j.create(data).reshape(28, 28);
        arr = Nd4j.pile(arr, arr);
        Map<String,INDArray> placeholder = new HashMap<>();
        placeholder.put(sd.inputs().get(0),arr);
        INDArray output = sd.outputSingle(placeholder,"dense_4/Softmax").get(NDArrayIndex.point(0));
    ...
    public static void main(String[] args) throws Exception{
        ...
        loadModel(dataLocalPath + "/Mnist/mnist.pb");
        for(int i = 1; i < 11; i++){
            String file = dataLocalPath + "/Mnist/images/img_%d.jpg";
