...
package org.deeplearning4j.quickstartexamples.dataexamples;
...
import org.deeplearning4j.quickstartexamples.utils.DownloaderUtility;
...
/**
 * FIXME: Wrong labels in test dataset
...
public class BasicCSVClassifier {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int batchSizeTraining = 30;    //Animals training data set: 30 quickstartexamples total. We are loading all of them into one DataSet (not recommended for large data sets)
     ...
     * provide some more quickstartexamples on how to convert INDArray to types that are more java
     * centric.
     */
